...
NICHE_TAGS: dict[str, list[tuple[str, str]]] = {
    ...
    "health clinics": [("amenity", "clinic"), ("healthcare", "clinic")],
    ...
    "marketing agencies": [("office", "advertising"), ("office", "company")],
    "massage therapists": [("shop", "massage"), ("healthcare", "massage")],
    "medical spas": [("leisure", "spa"), ("healthcare", "clinic")],
